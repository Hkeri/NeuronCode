...
@lru_cache
def requester(prompt: dict, system_prompt: str = "Be Helpful and Friendly", model: str = "Phind Instant", stream_chunk_size: int = 12, stream: bool = True) -> str:
    """
    ...
    with requests.Session() as session:
        ...
        response = session.post(chat_endpoint, headers=headers, json=payload, stream=True)
...
def generate(query):
    ...
    return requester(prompt=prompt, system_prompt=system_prompt, model="Phind-34B", stream=True)
