...
icon = p.image.load(f"{settings.dir_agi}\\features\\\\Chess\\icon.ico")
...
def loadImages():
    ...
    for piece in pieces: 
        IMAGES[piece] = p.transform.scale(p.image.load(f"{settings.dir_agi}\\features\\Chess\\" + piece + ".png"), (SQ_SIZE, SQ_SIZE))
