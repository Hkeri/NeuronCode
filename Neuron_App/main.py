...
from features.processor import response, image_generation
import random
...
customtkinter.set_default_color_theme(f"{settings.dir_agi}\\images\\cyan.json")
...
def melody():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\melody_generator.py"
    )


def tictactoe():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\ticTactoe.py"
    )


def calculator():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\gui_apps\\calc.py"
    )


def status():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\gui_apps\\status.py"
    )


def earth():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\gui_apps\\earth.py"
    )


def iss():
    os.system(
        f"{settings.python_exe_location} {settings.dir_agi}\\features\\gui_apps\\Iss.py"
    )
