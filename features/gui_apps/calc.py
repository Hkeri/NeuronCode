...
class App(CTk):
    def __init__(self):
        ...
        self.button_1 = CTkButton(
            master=self,
            text="1",
            command=lambda: self.g_num("1"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_2 = CTkButton(
            master=self,
            text="2",
            command=lambda: self.g_num("2"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_3 = CTkButton(
            master=self,
            text="3",
            command=lambda: self.g_num("3"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_4 = CTkButton(
            master=self,
            text="4",
            command=lambda: self.g_num("4"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_5 = CTkButton(
            master=self,
            text="5",
            command=lambda: self.g_num("5"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_6 = CTkButton(
            master=self,
            text="6",
            command=lambda: self.g_num("6"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_7 = CTkButton(
            master=self,
            text="7",
            command=lambda: self.g_num("7"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_8 = CTkButton(
            master=self,
            text="8",
            command=lambda: self.g_num("8"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        self.button_9 = CTkButton(
            master=self,
            text="9",
            command=lambda: self.g_num("9"),
            width=self.bwidth1,
            fg_color=self.nbc,
            hover_color=self.nbch,
        )
        ...
        self.equal = CTkButton(
            master=self, text="=", command=self.evaluate, width=self.bwidth1
        )
        self.clear = CTkButton(
            master=self, text="clear", command=self.all_clear, width=self.bwidth1
        )
